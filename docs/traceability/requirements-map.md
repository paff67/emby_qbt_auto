...
|---|---|---|---|
| 常驻 daemon + 多速率 loop | 旧系统是 3 分钟 timer oneshot | `qbt_orchestrator.daemon` | `test_daemon_safety_loop_only_uses_allowed_operations_and_pauses_below_floor` |
...
| Telegram auth/approval | 设计要求 viewer/operator/admin | `telegram_control` | `test_telegram_auth_approval_and_duplicate_click_idempotency` |
